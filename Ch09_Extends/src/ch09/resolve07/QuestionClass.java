...
public static void answer3(Scanner sc) {
	...
	double[] dArr = ArrayUtility.intToDouble(arrInt);
	System.out.println(Arrays.toString(dArr));
	
	double[] arrDou = { 0.5, 1.5, 2.5, 3.5, 4.5 };
	int[] iArr = ArrayUtility.doubleToInt(arrDou);
...
public static void answer4(Scanner sc) {
	...
	int[] result2 = ArrayUtility2.remove(a, b);
...
public static void answer5(Scanner sc) {
		...
		alex.get(alex, 2);
		james.give(alex, 2);
		System.out.println("Alex : "+alex.getBallCnt());
		System.out.println("James : "+james.getBallCnt());
		james.get(alex, 7);
		alex.give(james, 7);
		System.out.println("Alex : "+alex.getBallCnt());
		System.out.println("James : "+james.getBallCnt());
